...
#define INSTRUCTION_BYTES_PAN_TILT_SPEED 4
...
#define INSTRUCTION_ANGLE_BETWEEN_MEASUREMENTS 'b'
#define INSTRUCTION_DELAY_BETWEEN_MEASUREMENTS 'B'
...
#define EEPROM_ADDRESS_DEGREES_PER_MEASUREMENT 45
